...
public class MearyFoodMonthly extends Activity {
	...
	public void onCreate(Bundle savedInstanceState){
		...
		mProgress = ProgressDialog.show(MearyFoodMonthly.this, "기다려주세요~!", "다운로드중입니다...\n(최대소요시간 10초)");
	...
	class DownThread extends Thread{
		...
		Handler mAfterDown = new Handler(){
			public void handleMessage(Message msg){
				...
				m_adapter = new MenuAdapter(MearyFoodMonthly.this, R.layout.row, menusList);		
